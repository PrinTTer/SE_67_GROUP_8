...
const TimeSchedule = (prop) => {
  const { setInputs, inputs, handleInputChange } = prop;
  const [schedule, setSchedule] = useState([]); // เริ่มต้นจากอาร์เรย์ว่าง
    ...
    <div className="bg-gradient-to-br from-blue-100 to-blue-200 p-6 rounded-xl shadow-lg ">
      {schedule.length === 0 ? (
        <button
          ...
          className="w-full flex items-center justify-center bg-green-500 hover:bg-green-600 text-white py-2 rounded-md transition-colors"
        >
