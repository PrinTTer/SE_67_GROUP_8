...
import { deletePackageImage, deletePackages, getAllPackages, getPackage, allDetailPackages, registerPackage, uploadPackageImages } from "../controllers/package.controller";
