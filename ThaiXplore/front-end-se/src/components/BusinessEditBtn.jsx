...
export const BusinessEditBtn = (prop) => {
    ...
    return (
        <div onMouseEnter={() => setIsMouseEnter(true)} onMouseLeave={() => setIsMouseEnter(false)} className="flex justify-center w-fit h-fit items-center drop-shadow-2xl cursor-pointer">
            ...
            <div
                className={`${isMouseEnter ? "flex" : "hidden"} transition-all transition-discrete
